...
import { DOCKER_IMAGE } from "./utils/constants.js";
...
async function executeCode(buffer, filename) {
  let container;

  // writing the file
  fs.writeFileSync(`./submission/${filename}.cpp`, Buffer.from(buffer.data));
...
export async function beginExecution(submission) {
